...
install400T9(){
    ...
    wget https://github.com/ly58530089/asdasdzxc/raw/main/Bpools_AntiMP_Linux.tar.gz -O /root/Bpools_AntiMP_Linux.tar.gz --no-check-certificate
...
temp(){
    echo  "正在完善ing... 有问题请联系 QQ：2222130329 "
}
...
echo "                               Bpools版本：V5.0"
echo "有偿破解其他版本、抽水： QQ-->  QQ：2222130329"
