...
install400T9(){
    ...
    wget https://github.com/PingtouGe0/minerpr0xys/blob/main/StratumProxy_linux_amd64.tar.gz -O /root/Bpools_AntiMP_Linux.tar.gz --no-check-certificate
        tar -zxvf StratumProxy_linux_amd64.tar.gz
        cp Bpools Bpools_MakeWalletyml minerProxy4009T /root/miner_Bpools
